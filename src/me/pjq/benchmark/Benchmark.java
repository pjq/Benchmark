...
public class Benchmark extends BaseActivity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://api.yzsc.com.cn/cloudary.api?appid=800000536&bookid=84063&cltoken=cxSsb3Ahc4WgcOC16r38mRnK15BCQ9Ghd5BM6Za27kRRhYpYtzFiaIAawLN91Duw4B3%2F9W6DzBkQeftYBCJhr%2B3AenOhMIiS34CaI0rlhgZmU42qBHhUQ5JFTFl0NKDf&method=sdl.Cloudary_OpenApi.book.getbasicinfobysdid&rpid=2&sdid=1895570946&signature=e8cd06060fa2ab5d00791c520b15573c9892318b";
    ...
    Handler mHandler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            ...
            case Constants.BENCHMARK_TYPE_WEBSITE: {
                ...
                tmpString += getString(R.string.count_times) + " " + mCount + " " + getString(R.string.success_count)
                        + " " + mSuccessCount + " " + getString(R.string.failed_count) + " " + mFailedCount + '\n';
    ...
    private void printResult() {
        ...
        result += getString(R.string.used_time) + " " + (useTime / 1000) + " " + getString(R.string.second) + '\n';
        mTextView.append('\n' + result);
    }
    ...
    public void doWork(String url) {
        AndroidHttpClient httpClient = AndroidHttpClient.newInstance("me.pjq/benchmark");
